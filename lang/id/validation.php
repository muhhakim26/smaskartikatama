...
return [
    ...
    'attributes' => [
        ...
        'nomor-pendaftaran-siswa' => 'Nomor Pendaftaran',
        'email-siswa' => 'Email',
        'nama-siswa' => 'Nama',
        'no-hp-siswa' => 'Nomor HP Siswa',
        'nisn-siswa' => 'NISN',
        'provinsi-siswa' => 'Provinsi',
        'jenis-kelamin-siswa' => 'Jenis Kelamin',
        'kabupaten-siswa' => 'Kabupaten',
        'kecamatan-siswa' => 'Kecamatan',
        'tempat-lahir-siswa' => 'Tempat Lahir',
        'desa-kelurahan-siswa' => 'Desa/Kelurahan',
        'tanggal-lahir-siswa' => 'Tanggal Lahir',
        'kode-pos-siswa' => 'Kode POS',
        'agama-siswa' => 'Agama',
        'asal-sekolah-siswa' => 'Asal Sekolah',
        'alamat-siswa' => 'Alamat',
        'nama-ayah-siswa' => 'Nama Ayah',
        'pendikian-terakhir-ayah' => 'Pendidikan Terkahir Ayah',
        'pekerjaan-ayah' => 'Pekerjaan Ayah',
        'penghasilan-ayah' => 'Penghasilan Ayah',
        'no-hp-ayah' => 'Nomor HP Ayah',
        'nama-ibu-siswa' => 'Nama Ibu',
        'pendikian-terakhir-ibu' => 'Pendidikan Terkahir Ibu',
        'pekerjaan-ibu' => 'Pekerjaan Ibu',
        'penghasilan-ibu' => 'Penghasilan Ibu',
        'no-hp-ibu' => 'Nomor HP Ibu',
        'file-ft-siswa' => 'File Foto Siswa',
        'file-akte' => 'File Akte',
        'file-kk' => 'File Kartu Keluarga',
        'file-skhu' => 'File Surat Keterangan Hasil Ujian (SKHU)',
        'file-skm' => 'File Standar Kompetensi Mandiri (SKM)',
