                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('kelola-berita.update', $Berita->id) }}" class="d-flex flex-column gap-20" enctype="multipart/form-data" id="berita-create" method="post">
                        ...
                        <div>
                            ...
                            <div class="upload-image-wrapper">
                                <div class="uploaded-img d-none position-relative h-200-px w-100 input-form-light radius-8 overflow-hidden border border-dashed bg-neutral-50">
                                    ...
                                    <img alt="image" class="w-100 h-100 object-fit-cover" id="uploaded-img__preview" src="{{ asset('img/' . $Berita->file_foto) }}">
                                </div>
                        ...
                        <div>
                            ...
                            <textarea class="form-control" id="kutipan-berita" name="kutipan-berita">{{ old('kutipan-berita', $Berita->kutipan) }}</textarea>
                        ...
                        <div>
                            ...
                            <div class="radius-8 border border-neutral-200">
                                ...
                                <div id="editor">{!! old('deskripsi-berita', $Berita->deskripsi) !!}</div>
                                <!-- Edit End -->
                            </div>
                        </div>
