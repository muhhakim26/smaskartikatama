        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('kelola-sambutan-kepsek.store') }}" autocomplete="off" class="d-flex flex-column mt-20 gap-20" id="form" method="post">
                        @csrf
                        <div>
                            @error('deskripsi-kepsek')
                            ...
                            <div class="radius-8 border border-neutral-200">
                                ...
                                <!-- Editor Toolbar Start -->
                                <!-- Editor start -->
                                <textarea class="form-control d-none" id="deskripsi" name="deskripsi-kepsek"></textarea>
                                <div id="editor">{!! old('deskripsi-kepsek', $SambutanKepsek->deskripsi ?? '') !!}</div>
                                <!-- Edit End -->
                            </div>
                        </div>
