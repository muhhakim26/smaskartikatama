        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('kelola-galeri-foto.store') }}" autocomplete="off" class="d-flex flex-column gap-20" enctype="multipart/form-data" id="galeri-foto-create" method="post">
                        @csrf
                        <div>
                            <label class="form-label fw-bold text-neutral-900" for="nama-foto">Nama Foto</label>
                            <input class="form-control" id="nama-foto" name="nama-foto" type="text" value="{{ old('nama-foto') }}">
                            @error('nama-foto')
