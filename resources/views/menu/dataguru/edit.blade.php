...
@section('konten')
    ...
    <form action="{{ route('kelola-data-guru.update', $DataGuru->id) }}" enctype="multipart/form-data" id="dataguru-edit" method="post">
        @csrf
        @method('put')
        <div>
            <label for="nama-guru">Nama Guru</label>
            <input id="nama-guru" name="nama-guru" type="text" value="{{ old('nama-guru', $DataGuru->nama) }}">
        </div>
        @error('nama-guru')
        ...
        <div>
            ...
            <input id="nip-guru" name="nip-guru" required type="number" value="{{ old('nip-guru', $DataGuru->nip) }}">
        </div>
        @error('nip-guru')
            <div class="alert alert-danger">{{ $message }}</div>
        @enderror
        <div>
            ...
            <input id="bidang-guru" name="bidang-guru" type="text" value="{{ old('bidang-guru', $DataGuru->bidang) }}">
        </div>
        @error('bidang-guru')
            <div class="alert alert-danger">{{ $message }}</div>
        @enderror
        <div>
            ...
            <input id="jabatan-guru" name="jabatan-guru" type="text" value="{{ old('jabatan-guru', $DataGuru->jabatan) }}">
        </div>
        @error('jabatan-guru')
            <div class="alert alert-danger">{{ $message }}</div>
        @enderror
