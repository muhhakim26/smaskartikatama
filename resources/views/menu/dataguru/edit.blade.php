        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('kelola-data-guru.update', $DataGuru->id) }}" autocomplete="off" class="d-flex flex-column gap-20" enctype="multipart/form-data" id="dataguru-edit" method="post">
                        @csrf
                        @method('put')
                        <div>
                            <label class="form-label fw-bold text-neutral-900" for="nama-guru">Nama Guru</label>
                            <input class="form-control" id="nama-guru" name="nama-guru" type="text" value="{{ old('nama-guru', $DataGuru->nama) }}">
                            @error('nama-guru')
                        ...
                        <div>
                            ...
                            <input class="form-control" id="nip-guru" name="nip-guru" required type="number" value="{{ old('nip-guru', $DataGuru->nip) }}">
                            @error('nip-guru')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div>
                            ...
                            <input class="form-control" id="bidang-guru" name="bidang-guru" type="text" value="{{ old('bidang-guru', $DataGuru->bidang) }}">
                            @error('bidang-guru')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div>
                            ...
                            <input class="form-control" id="jabatan-guru" name="jabatan-guru" type="text" value="{{ old('jabatan-guru', $DataGuru->jabatan) }}">
                            @error('jabatan-guru')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
