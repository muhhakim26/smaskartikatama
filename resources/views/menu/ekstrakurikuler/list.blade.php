    ...
    <div class="card h-100 radius-12 basic-data-table p-0">
        <div class="card-header border-bottom bg-base d-flex align-items-center justify-content-between flex-wrap gap-3 px-24 py-16">
            <div class="d-flex align-items-center flex-wrap gap-3">
                <h6 class="fw-semibold mb-0">Kelola Ekstrakurikuler</h6>
            </div>
            <a class="btn btn-primary btn-sm radius-8 d-flex align-items-center gap-2 px-12 py-12 text-sm" href="{{ route('kelola-ekstrakurikuler.create') }}">
