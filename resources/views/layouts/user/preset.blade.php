            ...
            <nav class="navbar navbar-expand-lg bg-body-tertiary">
                <div class="container">
                    <a class="navbar-brand d-flex align-items-center" href="{{ route('home') }}">
                        <img alt="Logo SMAS Kartikatama Metro" class="w-50-px h-50-px me-10" src="https://placehold.co/50">
                    ...
                    <div class="navbar-collapse collapse" id="navigasi">
                        <ul class="navbar-nav fw-medium align-items-center ms-auto">
                            ...
                            <li class="nav-item dropdown mx-8">
                                ...
                                <a aria-expanded="false" @class(['nav-link','dropdown-toggle', 'active' => Route::is('sambuatan')||Route::is('sejarah')||Route::is('visi-misi')||Route::is('struktur-organisasi')||Route::is('guru')])  data-bs-toggle="dropdown" href="#" role="button">
                                    Profil
                                </a>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a @class(['dropdown-item', 'active' => Route::is('struktur-organisasi')]) href="{{ route('struktur-organisasi') }}">Struktur</a></li>
                            ...
                            <li class="nav-item dropdown mx-8">
                                {{-- blade-formatter-disable --}}
                                <a aria-expanded="false" @class(['nav-link','dropdown-toggle', 'active' => Route::is('osis')||Route::is('ekstrakurikuler')]) data-bs-toggle="dropdown" href="#" role="button">
                                    Kesiswaan
                                </a>
                                 {{-- blade-formatter-enable --}}
                                <ul class="dropdown-menu">
                            ...
                            <li class="nav-item m-auto">
                                <a class="btn btn-primary radius-50 px-20 py-12" href="{{ route('ppdb') }}">
                                    Pendaftaran PPDB
                                </a>
                            </li>
                        </ul>
                ...
                <div class="row g-5">
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        ...
                        <div class="d-flex gap-3">
                            <a class="link-body-emphasis" href="#"><iconify-icon height="24" icon="mdi:instagram" width="24"></iconify-icon></a>
                            <a class="link-body-emphasis" href="#"><iconify-icon height="24" icon="ic:baseline-facebook" width="24"></iconify-icon></a>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        ...
                        <div class="d-flex flex-column lh-lg">
                            <a class="text-body-secondary text-hover-primary-600 transition-2 p-0" href="#">Berita</a>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        ...
                        <div class="d-flex flex-column w-100 gap-4">
                            <a class="btn btn-primary-600 rounded-pill radius-50 px-20 py-12" href="{{ route('ppdb') }}">Daftar PPDB</a>
                            <a class="btn btn-primary-600 rounded-pill radius-50 px-20 py-12" href="{{ route('info-ppdb') }}">Syarat PPDB</a>
                        </div>
                    </div>
                </div>
