...
<html data-theme="light" lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        @if (Route::is('dashboard*', 'admin*', 'kelola*') && !Route::currentRouteNamed('admin.login'))
            <aside class="sidebar">
                ...
                <div>
                    <a class="sidebar-logo" href="{{ route('home') }}">
                        ...
                        <img alt="site logo" class="dark-logo" src="assets/images/logo-light.png">
                        <img alt="site logo" class="logo-icon" src="assets/images/logo-icon.png">
                    </a>
                </div>
                            ...
                            <div class="d-flex align-items-center flex-wrap gap-3">
                                ...
                                <div class="dropdown">
                                    <button class="d-flex justify-content-center align-items-center rounded-circle" data-bs-toggle="dropdown" type="button">
                                        <img alt="image" class="w-40-px h-40-px object-fit-cover rounded-circle" src="assets/images/user.png">
                                    </button>
                                    <div class="dropdown-menu to-top dropdown-menu-sm">
                                        <div class="radius-8 bg-primary-50 d-flex align-items-center justify-content-between mb-16 gap-2 px-16 py-12">
                                            <div>
                                                <h6 class="text-primary-light fw-semibold mb-2 text-lg">Shaidul Islam</h6>
                                        ...
                                        <ul class="to-top-list">
                                            <li>
                                                <a class="dropdown-item hover-bg-transparent hover-text-primary d-flex align-items-center gap-3 px-0 py-8 text-black" href="view-profile.php">
                                                    <iconify-icon class="icon text-xl" icon="solar:user-linear"></iconify-icon> My Profile
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item hover-bg-transparent hover-text-danger d-flex align-items-center gap-3 px-0 py-8 text-black" href="javascript:void(0)">
